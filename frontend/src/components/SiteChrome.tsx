...
export function InputTrustNotes() {
  return (
    <ul className="input-trust-notes" aria-label="Privacy and pricing">
      <li>
        We don&apos;t save or keep your resume. It&apos;s only used to run your
        analysis.
      </li>
      <li>
        Doesn&apos;t cost you anything, but donations are always appreciated.
      </li>
    </ul>
  );
}
  ...
  return (
    <section className="site-hero" aria-labelledby="site-hero-title">
      ...
      <p className="site-hero-lead">
        Upload your resume. We infer aptitudes, match careers, recommend roles to
        target, and search for verified job postings — in one pipeline.
      </p>
    </section>
  );
}
